...
import {
  EventVenue,
  EventVenueSchema,
} from './infrastructure/schemas/event-venue.schema';
import {
  EventOrganizer,
  EventOrganizerSchema,
} from './infrastructure/schemas/event-organizer.schema';
import {
  EventCategory,
  EventCategorySchema,
} from './infrastructure/schemas/event-category.schema';
...
import {
  EventRsvp,
  EventRsvpSchema,
} from './infrastructure/schemas/event-rsvp.schema';
...
import {
  EventHashtag,
  EventHashtagSchema,
} from './infrastructure/schemas/event-hashtag.schema';
...
import {
  EventHashtagMapping,
  EventHashtagMappingSchema,
} from './infrastructure/schemas/event-hashtag-mapping.schema';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: EventOrganizerRepository,
      useClass: EventOrganizerRepositoryImpl,
    },
